...
export default function Intake() {
  ...
  return (<div className="grid cols-2">
    <section className="card stack"><div className="row">
      ...
      <select className="input" style={{maxWidth:120}} value={matcher} onChange={e=>setMatcher(e.target.value)}>
        <option value="hybrid">Hybrid</option><option value="ai">AI</option><option value="rules">Rules</option></select>
      ...
      {err && <div className="err">{err}</div>}</section>
